<?php
    ...
    else
    {
        ...
        $firstday = $_SESSION['niestandardowydzien1'];
        $lastday = $_SESSION['niestandardowydzien2'];
        
        $dat1 = date("Y-m-d", strtotime($firstday));
        $dat2 = date("Y-m-d", strtotime($lastday));
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    elseif($rezultat->num_rows == 0)
                                        {
                                        echo "BRAK PRZYCHODÓW NA TEN OKRES";
                                        }
                                    else
                             ...
                             <tbody>
                                ...
                                <?php
                                    ...
                                    elseif($rezultat->num_rows == 0)
                                        ...
                                        echo "BRAK WYDATKÓW NA TEN OKRES";
                                        }
                                    else
                                       echo '<span style="color:red;">BRAK POŁĄCZENIA Z SERWEREM, PRZEPRASZAMY SPRÓBUJ PÓŹNIEJ</span>';
                                ?>
