<?php
    ...
    else
    {
        ...
        $firstdayPreviousMonth = date("d-m-Y", strtotime("first day of Previous month"));
        $lastdayPreviousMonth = date("d-m-Y", strtotime("last day of Previous month"));
        
        $dat1 = date("Y-m-d", strtotime("first day of Previous month"));
        $dat2 = date("Y-m-d", strtotime("last day of Previous month"));
        ...
        <article class="walletspage">
            <div class="container">
                <header class="dateBalance">
                    <h1 class="font-weight-bold text-uppercase mb-2">Bilans za poprzedni miesiąc</h1>
                    <div class="textIn" style="color: #384D93; font-size: 20px; font-weight: bold;">
                        <?php
                        echo "Od ".$firstdayPreviousMonth." do ".$lastdayPreviousMonth;
                    ?>
                    </div>
                </header>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    elseif($rezultat->num_rows == 0)
                                        {
                                        echo "BRAK PRZYCHODÓW NA POPRZEDNI MIESIĄC";
                                        }
                                    else
                             ...
                             <tbody>
                                ...
                                <?php
                                    ...
                                    elseif($rezultat->num_rows == 0)
                                        ...
                                        echo "BRAK WYDATKÓW NA POPRZEDNI MIESIĄC";
                                        }
                                    else
                                       echo '<span style="color:red;">BRAK POŁĄCZENIA Z SERWEREM, PRZEPRASZAMY SPRÓBUJ PÓŹNIEJ</span>';
                                ?>
