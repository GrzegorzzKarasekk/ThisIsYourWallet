<?php
    ...
    else
    {
        ...
        $firstdayThisYear = date("d-m-Y", strtotime("first day of january This Year"));
        $lastdayThisYear = date("d-m-Y", strtotime("last day of This Year"));
        
        $dat1 = date("Y-m-d", strtotime("first day of january This Year"));
        $dat2 = date("Y-m-d", strtotime("last day of this Year"));
       ...
       <article class="walletspage">
            <div class="container">
                <header class="dateBalance">
                    <h1 class="font-weight-bold text-uppercase mb-2">Bilans za ten rok</h1>
                    <div class="textIn" style="color: #384D93; font-size: 20px; font-weight: bold;">
                        <?php
                        echo "Od ".$firstdayThisYear." do ".$lastdayThisYear;
                    ?>
                    </div>
                </header>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    elseif($rezultat->num_rows == 0)
                                        {
                                        echo "BRAK PRZYCHODÓW NA TEN ROK";
                                        }
                                    else
